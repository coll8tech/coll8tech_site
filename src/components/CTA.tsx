    ...
    <section id="contact" ref={ref} className="py-32 px-6 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          className="bg-gray-900 rounded-3xl p-12 md:p-16 text-center relative overflow-hidden"
        >
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            >
              Let's connect and discuss how we can help you find the perfect talent
            </motion.p>
